...
if __name__ == "__main__":
    ...
    # ctr = Counter({"a":2, "b":5, "c":4, "d": 1, "e":1})
    # ctr_remove_below_threshold(ctr, threshold=6)
    # print ctr
    # print ctr.keys()

    print ark_tweet_tokenizer(text="I want this!")

    # print get_ngrams_from_list("this is", 2,2)
    # print ark_tweet_tokenizer("this is a test.")
    # # st = load_ner()
    # # print st.tag("""Stephen A. Young, M.D. Peyton H. Hurt, M.D.,""".split())
    #
    # # texts = ["this is 1", "this is 2", "this is 3", "this is 4", "this is 5", "this is 6", "this is 7",
    # #      "this is 8", "this is 9", "this is 0", "this is 1", "this is 2", "this is 3", "this is 4",
    # #      "this is 5", "this is 6"]
    # # print get_ngrams_from_list(texts, 3, 3)
    # # print len(texts)
    #
    # l1 = range(20)
    # size = 10
    # print get_ngrams_with_step_size(l1, size, int(size*0.5))
    # print get_ngrams_with_step_size(l1, size, int(1))
    #
...
# print get_ngrams_from_list("hel o", 3, 3)
